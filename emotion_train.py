...
dataset_path = "D:/FInal year project/my project/fer2013.csv" 
...
checkpointer = ModelCheckpoint('D:/FInal year project/my project/weights.hd5', monitor='val_loss', verbose=1, save_best_only=True)
...
model.save_weights("D:/FInal year project/my project")
